...
export default tseslint.config(
  ...
  {
    plugins: { "@next/next": nextPlugin, "jsx-a11y": jsxA11y, boundaries },
    settings: {
  ...
  {
    // The no-react/no-next restriction only applies inside core/ — components
    // and features are meant to import React freely.
    files: ["src/core/**/*.ts"],
    rules: {
      "no-restricted-imports": [
        "error",
